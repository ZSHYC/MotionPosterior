"""Official TrackNetV3 heatmap baseline configuration.

The optional ``InpaintNetV3`` rectifier is trained separately on coordinate
sequences, matching the released two-stage V3 pipeline.
"""
...
model = dict(type='TrackNetV3', in_dim=9, out_dim=3, num_frames=num_frames)
